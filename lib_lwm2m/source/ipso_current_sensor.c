...
#if defined(CONFIG_LCZ_LWM2M_IPSO_CURRENT_SENSOR_VERSION_1_1)
#define CURRENT_VERSION_MINOR 1
#define NUMBER_OF_OBJ_FIELDS 13
#else
#define CURRENT_VERSION_MINOR 0
#define NUMBER_OF_OBJ_FIELDS 9
#endif /* defined(CONFIG_LCZ_LWM2M_IPSO_CURRENT_SENSOR_VERSION_1_1) */

#define MAX_INSTANCE_COUNT CONFIG_LCZ_LWM2M_IPSO_CURRENT_SENSOR_INSTANCE_COUNT
