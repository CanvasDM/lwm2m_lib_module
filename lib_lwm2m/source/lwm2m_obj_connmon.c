...
#endif /* CONFIG_LCZ_LWM2M_CONNMON_OBJECT_VERSION_1_2 */
...
#define CONNMON_AVAIL_BEARER_MAX	CONFIG_LCZ_LWM2M_CONN_MON_BEARER_MAX
#define CONNMON_APN_MAX			CONFIG_LCZ_LWM2M_CONN_MON_APN_MAX
