...
#if defined(CONFIG_LCZ_LWM2M_IPSO_GENERIC_SENSOR_VERSION_1_1)
#define GENERIC_VERSION_MINOR 1
#define NUMBER_OF_OBJ_FIELDS 13
#else
#define GENERIC_VERSION_MINOR 0
#define NUMBER_OF_OBJ_FIELDS 9
#endif /* defined(CONFIG_LCZ_LWM2M_IPSO_GENERIC_SENSOR_VERSION_1_1) */

#define MAX_INSTANCE_COUNT CONFIG_LCZ_LWM2M_IPSO_GENERIC_SENSOR_INSTANCE_COUNT

#define IPSO_OBJECT_ID IPSO_OBJECT_GENERIC_SENSOR_ID

#define SENSOR_NAME CONFIG_LCZ_LWM2M_IPSO_GENERIC_SENSOR_NAME
...
BUILD_ASSERT(SENSOR_TYPE_STR_MAX_SIZE >=
	     sizeof(CONFIG_LCZ_LWM2M_IPSO_GENERIC_SENSOR_TYPE),
	     "CONFIG_LCZ_LWM2M_IPSO_GENERIC_SENSOR_TYPE is too long.");
...
static struct lwm2m_engine_obj_inst *generic_sensor_create(uint16_t obj_inst_id)
{
	...
	app_type[index][0] = '\0';
	strncpy(sensor_type[index], CONFIG_LCZ_LWM2M_IPSO_GENERIC_SENSOR_TYPE,
