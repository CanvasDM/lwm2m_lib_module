...
#define PACKAGE_NAME_LEN CONFIG_LCZ_LWM2M_SWMGMT_PACKAGE_NAME_LEN
#define PACKAGE_VERSION_LEN CONFIG_LCZ_LWM2M_SWMGMT_PACKAGE_VERSION_LEN
#define PACKAGE_URI_LEN CONFIG_LCZ_LWM2M_SWMGMT_PACKAGE_URI_LEN
#define MAX_INSTANCE_COUNT CONFIG_LCZ_LWM2M_SWMGMT_MAX_INSTANCE_COUNT
...
#ifdef CONFIG_LCZ_LWM2M_FIRMWARE_UPDATE_PULL_SUPPORT
...
static struct lwm2m_engine_obj_inst *swmgmt_create(uint16_t obj_inst_id)
{
	...
	INIT_OBJ_RES(SWMGMT_PACKAGE_URI_ID, res[index], res_idx, res_inst[index], res_inst_idx, 1,
		     true, true, instance->package_uri, PACKAGE_URI_LEN, NULL, NULL,
