...
#if defined(CONFIG_LCZ_LWM2M_SERVER_OBJECT_VERSION_1_1)
#define SERVER_VERSION_MINOR 1
#define SERVER_MAX_ID		 24
#else
#define SERVER_VERSION_MINOR 0
#define SERVER_MAX_ID		 9
#endif /* defined(CONFIG_LCZ_LWM2M_SERVER_OBJECT_VERSION_1_1) */
...
#define MAX_INSTANCE_COUNT		CONFIG_LCZ_LWM2M_SERVER_INSTANCE_COUNT
...
static struct lwm2m_engine_obj_inst *server_create(uint16_t obj_inst_id)
{
	...
	lifetime[index] = CONFIG_LCZ_LWM2M_ENGINE_DEFAULT_LIFETIME;
	default_min_period[index] = CONFIG_LCZ_LWM2M_SERVER_DEFAULT_PMIN;
	default_max_period[index] = CONFIG_LCZ_LWM2M_SERVER_DEFAULT_PMAX;
