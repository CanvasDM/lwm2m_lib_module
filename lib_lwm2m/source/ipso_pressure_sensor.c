...
#if defined(CONFIG_LCZ_LWM2M_IPSO_PRESSURE_SENSOR_VERSION_1_1)
...
#endif /* defined(CONFIG_LCZ_LWM2M_IPSO_PRESSURE_SENSOR_VERSION_1_1) */

#define MAX_INSTANCE_COUNT CONFIG_LCZ_LWM2M_IPSO_PRESSURE_SENSOR_INSTANCE_COUNT
