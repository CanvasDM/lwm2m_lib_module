...
#define MAX_INSTANCE_COUNT CONFIG_LCZ_LWM2M_GATEWAY_MAX_INSTANCES

BUILD_ASSERT(CONFIG_LCZ_LWM2M_ENGINE_VALIDATION_BUFFER_SIZE >= CONFIG_LCZ_LWM2M_GATEWAY_PREFIX_MAX_STR_SIZE,
...
struct lwm2m_gw_obj {
	char device_id[CONFIG_LCZ_LWM2M_GATEWAY_DEVICE_ID_MAX_STR_SIZE];
	char prefix[CONFIG_LCZ_LWM2M_GATEWAY_PREFIX_MAX_STR_SIZE];
	char iot_device_objects[CONFIG_LCZ_LWM2M_GATEWAY_IOT_DEVICE_OBJECTS_MAX_STR_SIZE];
};
...
static struct lwm2m_engine_obj_inst *lwm2m_gw_create(uint16_t obj_inst_id)
{
	...
	/* Set default values */
	strncpy(device_table[index].device_id, CONFIG_LCZ_LWM2M_GATEWAY_DEFAULT_DEVICE_ID,
		CONFIG_LCZ_LWM2M_GATEWAY_DEVICE_ID_MAX_STR_SIZE);
	snprintk(device_table[index].prefix, CONFIG_LCZ_LWM2M_GATEWAY_PREFIX_MAX_STR_SIZE,
		 CONFIG_LCZ_LWM2M_GATEWAY_DEFAULT_DEVICE_PREFIX "%u", index);
	strncpy(device_table[index].iot_device_objects,
		CONFIG_LCZ_LWM2M_GATEWAY_DEFAULT_IOT_DEVICE_OBJECTS,
		CONFIG_LCZ_LWM2M_GATEWAY_IOT_DEVICE_OBJECTS_MAX_STR_SIZE);
	...
	INIT_OBJ_RES(LWM2M_GATEWAY_PREFIX_RID, res[index], i, res_inst[index], j, 1, false, true,
		     device_table[index].prefix, CONFIG_LCZ_LWM2M_GATEWAY_PREFIX_MAX_STR_SIZE, NULL,
