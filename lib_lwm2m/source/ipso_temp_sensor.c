...
#if defined(CONFIG_LCZ_LWM2M_IPSO_TEMP_SENSOR_VERSION_1_1)
#define TEMP_VERSION_MINOR 1
#define TEMP_MAX_ID 12
#else
#define TEMP_VERSION_MINOR 0
#define TEMP_MAX_ID 7
#endif /* defined(CONFIG_LCZ_LWM2M_IPSO_TEMP_SENSOR_VERSION_1_1) */

#define MAX_INSTANCE_COUNT	CONFIG_LCZ_LWM2M_IPSO_TEMP_SENSOR_INSTANCE_COUNT
